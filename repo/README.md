...
|--------|-------------|-------|
| [Your Name] | EDA, stationarity, cointegration, pair selection, OU forecasting, Granger causality, report | OU Process |
| Akshaj Chandwani | Data procurement, feature engineering, Z-score signals, half-life window design | Rolling OLS (Model 2) |
| [Member 3] | VECM implementation, walk-forward CV, OOS backtest, model comparison | VECM (Model 3) + OOS |
